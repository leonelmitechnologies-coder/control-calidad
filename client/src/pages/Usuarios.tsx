  ...
  return (
    <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
      <div
        ...
        style={{ border: "1px solid #e2e2e2", maxHeight: "90vh" }}
      >
        {/* Header */}
                ...
                return (
                  <tr key={u.id}>
                    <td style={{ fontWeight: 500 }}>
                      {u.nombre}
                      {esMio && (
                        <span style={{ marginLeft: 8, fontSize: 10, color: "#aaa" }}>(tú)</span>
                      )}
                    </td>
                    ...
                    <td>
                      <span
                        className={
                          u.rol === "Administrador" ? "badge badge-admin" : "badge badge-usuario"
                        }
                      >
                        {u.rol}
                      </span>
