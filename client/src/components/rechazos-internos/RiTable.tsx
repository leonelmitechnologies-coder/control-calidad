    ...
    return (
      <div className="vacio" style={{ border: "1px dashed #ccc", padding: 64 }}>
        <svg
          ...
          viewBox="0 0 24 24"
          aria-hidden="true"
          style={{ color: "#ccc", margin: "0 auto 12px" }}
        >
          <path
            strokeLinecap="round"
        ...
        <table className="tabla">
          ...
          <thead>
            <tr>
              ...
              <th className="whitespace-nowrap" style={{ maxWidth: 180 }}>
                {t("rechazos_internos.table.actividad")}
              </th>
              <th className="whitespace-nowrap" style={{ color: "#2563a8" }}>
          ...
          <tbody>
            {data.map((ri, idx) => {
              const imgCount =
                typeof ri.cnt_images === "number" ? ri.cnt_images : (ri.images?.length ?? 0);
                  ...
                  <td className="centrado whitespace-nowrap">
                    {imgCount > 0 ? (
                      <span
                        ...
                        style={{ color: "#2563a8", fontSize: 11, fontWeight: 500 }}
                      >
                        <svg
                          className="h-3 w-3"
                          fill="none"
            ...
            {Array.from({ length: Math.min(totalPages, 7) }, (_, i) => {
              ...
              return (
                <button
                  ...
                  style={
                    pageNum === page
                      ? { background: "#0d2b4e", color: "#fff", borderColor: "#0d2b4e" }
                      : {}
                  }
                >
                  {pageNum}
