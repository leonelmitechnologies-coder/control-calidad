      ...
      >
        ...
        <div className="overflow-y-auto px-6 py-5 flex-1">
          ...
          <div className="flex items-center gap-4" style={{ marginBottom: 20 }}>
            ...
            <div className="min-w-0">
              ...
              <span
                className={`badge badge-${employee.estatus === "activo" ? "activo" : "inactivo"}`}
              >
        ...
        >
          <div className="btn-grupo" style={{ marginTop: 0 }}>
            ...
            <button type="button" onClick={onStatusChange} className="btn btn-secundario">
              {t("organigrama.cambiar_estatus")}
            </button>
          </div>
          <div className="btn-grupo" style={{ marginTop: 0 }}>
            <button type="button" onClick={onDelete} className="btn btn-peligro">
