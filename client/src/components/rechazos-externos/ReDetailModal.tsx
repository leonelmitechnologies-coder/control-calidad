  ...
  return createPortal(
    ...
    >
      ...
      <div
        ...
        style={{ maxWidth: 780, background: "#fff", border: "1px solid #e2e2e2" }}
      >
        {/* Header */}
        <div
          ...
          {probs.length > 0 && (
            <div style={{ marginBottom: 20 }}>
              ...
              {probs.map((p, idx) => (
                <div
                  key={idx}
                  style={{ border: "1px solid #e2e2e2", padding: "10px 14px", marginBottom: 8 }}
                >
                  <p
                    style={{
                      fontSize: 11,
            ...
            <div style={{ marginBottom: 20 }}>
              ...
              {depts.map((dept) => {
                ...
                return (
                  <div
                    key={dept}
                    style={{ border: "1px solid #0d2b4e", padding: "10px 14px", marginBottom: 8 }}
                  >
                    <p
                      style={{
                        fontSize: 11,
        ...
        >
          <div className="btn-grupo" style={{ marginTop: 0 }}>
            ...
            <button type="button" className="btn btn-secundario" onClick={() => generatePdf(data)}>
              &#128196; Generar PDF
            </button>
            <button
              type="button"
